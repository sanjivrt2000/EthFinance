...
//        <Link route={`/campaigns/${this.props.address}/requests`}>
 ...
 // }
  ...
  render() {
    ...
    return(
      <Layout>
        ...
        <Grid.Row>
          ...
          <Grid.Row>
          <Grid.Column>
                  <Link route={`/customer/${this.props.instaddr}/pages/accountinfo`}>
                    <a>
        ...
        <Grid.Row>
        <Grid.Column>
                <Link route={`/customer/${this.props.instaddr}/pages/financelist`}>
                  <a>
                    <Button primary>Finance List</Button>
                  </a>
                </Link>
                </Grid.Column>
      </Grid.Row>
      <Grid.Row>
      <Grid.Column>
              <Link route={`/customer/${this.props.instaddr}/pages/loanpool`}>
                <a>
    ...
    <Grid.Row>
    <Grid.Column>
            <Link route={`/customer/${this.props.instaddr}/pages/tranhistory`}>
              <a>
